...
public class GameConroller : MonoBehaviour
{
    ...
    public void GameOverScreen()
    {
        ...
        if (chanceToAnotherChance >= 5)
        {
            ...
            anotherChance.AnotherChance(tempApplePrice + 15+(appleCount/100+tempApplePrice), 10);
            chanceToAnotherChance++;
        }
        else
        {
            ...
            //lastAppleText.text = "ЯБЛОК " + $"{PlayerPrefs.GetInt("AppleMax")}";
            ...
            //StageText.text = levelText.text;
            //AllKnifeCountText.text = knifesText.text;
        }
